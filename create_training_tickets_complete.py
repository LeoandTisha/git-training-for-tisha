#!/usr/bin/env python3
"""
Create complete Jira tickets for Git training with full instructions.
"""
...
print(f"Creating Module 1...")
create_ticket("INFRA", "Module 1: Git Fundamentals", module1_desc, "Task", TISHA_ID, epic_key, 3, "2025-07-14")
time.sleep(1)
...
create_ticket("INFRA", "Module 2: GitHub Basics", module2_desc, "Task", TISHA_ID, epic_key, 2, "2025-07-15")
time.sleep(1)
...
create_ticket("INFRA", "Module 3: LeoLab Workflow", module3_desc, "Task", TISHA_ID, epic_key, 3, "2025-07-16")
time.sleep(1)
...
3. PR must include:
   - Title: [TRAINING-4] Your description
...
create_ticket("INFRA", "Module 4: Pull Requests & Code Review", module4_desc, "Task", TISHA_ID, epic_key, 2, "2025-07-17")
time.sleep(1)
...
create_ticket("INFRA", "Module 5: Security & Best Practices", module5_desc, "Task", TISHA_ID, epic_key, 2, "2025-07-17")
time.sleep(1)
...
create_ticket("INFRA", "Module 6: Hands-On Practice Project", module6_desc, "Task", TISHA_ID, epic_key, 4, "2025-07-22")
time.sleep(1)
...
create_ticket("INFRA", "Module 7: Final Assessment & Quick Reference", module7_desc, "Task", TISHA_ID, epic_key, 2, "2025-07-23")
time.sleep(1)
...
create_ticket("INFRA", "Review & Buffer Time", module8_desc, "Task", TISHA_ID, epic_key, 1, "2025-07-24")

print(f"\n✅ Created Epic {epic_key} with 8 complete training modules!")
print("Each ticket now has full instructions in the description.")
print("\nNext steps:")
print("1. Delete the old tickets (INFRA-38 through INFRA-46)")
print("2. Push training materials to GitHub")
print("3. Create practice repository for Module 2")